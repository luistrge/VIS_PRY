...
#' Cyberpunk Scientific - Turquesa (#06B6D4) con Pico en Amarillo Neón (#FDE047)
#'
#' @param data Filtered country data
#' @return Plotly figure
    ...
    layout(
      ...
      annotations = list(
        list(
          ...
          text = "PICO",
          showarrow = FALSE,
          font = list(color = "#FDE047", size = 12, family = "Inter", weight = 700),
          yshift = 25
        )
      )
    )
...
#' Cyberpunk Scientific - Naranja Quemado (#F97316) con Pico en Rosa Pálido (#FECACA)
#'
#' @param data Filtered country data
#' @return Plotly figure
    ...
    layout(
      ...
      annotations = list(
        list(
          ...
          text = "PICO",
          showarrow = FALSE,
          font = list(color = "#FECACA", size = 12, family = "Inter", weight = 700),
          yshift = 25
        )
      )
    )
